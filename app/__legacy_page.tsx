...
/* A verbatim copy of app/page.tsx as it stood before the component split, kept
   only long enough to prove the split changed nothing. tests/refactor.test.tsx
   drives this and the new page through the same script against the same
   payload and compares what each one rendered, step by step. Both this file
   and that test go away with the accessibility work, which changes the markup
   on purpose and so is the point at which "identical to the old one" stops
   being the thing worth asserting. */
